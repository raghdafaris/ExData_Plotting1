...
# Open a graphics window with a specific size
#win.graph(200, 200)
...
plot(df$dateTime, df$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)",xaxt = "n")
...
plot(df$dateTime, df$Sub_metering_1, type = "l", xlab = "", ylab = "Energy sub metering" ,xaxt = "n")
...
plot(df$dateTime, df$Global_reactive_power, type = "l", xlab = "daytime", ylab = "Global Reactive Power (kilowatts)",xaxt = "n")
